...
public class MainActivity extends AppCompatActivity {
    ...
    public void borrar(View v) {//3 tipos de borrado
        ...
        switch (v.getId()) {
            ...
            case R.id.btnc: //borrado completo
                texto = "";
                texto2 = "";
                numero = 0;
                NumA = 0;
...
try {
    ...
    public void bloqueo(View v){
        ...
        if(estadoBotones){
            ...
            //demas operaciones
            View ce = findViewById(R.id.btnc);
            ce.setEnabled(false);



            View borrador = findViewById(R.id.btnBorrar);
            ...
            View pi = findViewById(R.id.btnE);
            pi.setEnabled(false);
            ...
            Toast.makeText(getApplicationContext(),"Bloqueado teclado",Toast.LENGTH_SHORT).show();
            estadoBotones=false;
        }else {
